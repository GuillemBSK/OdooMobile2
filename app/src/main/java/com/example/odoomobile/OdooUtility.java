...
public class OdooUtility {
    ...
    public OdooUtility(String serverAddress, String common) {
    }
     ...
     * @param listener XMLRPCCallback to receive response from the server
    asyncly
     ...
     * @return
     *********************************************************************/
    public M2OField getMany2One(Map<String, Object> classObj, String
            fieldName){
        Integer fieldId=0;
        String fieldValue="";
